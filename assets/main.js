...
sr.reveal(`.home_dam-2, .home_dam-3`, {
  delay: 1400,
  scale: 0,
  rotate: { z: 45 },
});
...
sr.reveal(".contact_img-1", {
  delay: 1000,
  distance: 0,
  scale: 0,
  rotate: { z: -45 },
});
sr.reveal(".contact_img-2", {
  delay: 1200,
  distance: 0,
  scale: 0,
  rotate: { z: 45 },
...
sr.reveal(".contact_dam-2", { delay: 1600, scale: 0, rotate: { z: 45 } });
sr.reveal(".contact_dam-3", { delay: 1800, scale: 0, rotate: { z: 45 } });
